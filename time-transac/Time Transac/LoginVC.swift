...
class LoginVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        gradientViewLogin.setColors([#colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1),#colorLiteral(red: 0.9411764741, green: 0.4980392158, blue: 0.3529411852, alpha: 1)])
