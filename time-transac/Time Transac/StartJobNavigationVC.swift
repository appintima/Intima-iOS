...
class StartJobNavigation: UIViewController, MGLMapViewDelegate, CLLocationManagerDelegate, VoiceControllerDelegate {
    ...
    @IBAction func replay(_ sender: Any) {
        let bundle = Bundle(for: StartJobNavigation.self)
    ...
    func startCustomNavigation() {
        ...
        guard let customViewController = storyboard?.instantiateViewController(withIdentifier: "custom") as? OnJobNavigation else { return }
...
extension StartJobNavigation: WaypointConfirmationViewControllerDelegate {
